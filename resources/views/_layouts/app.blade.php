...
<head>
    ...
    <title>Beliya Totebag Indonesia</title>
...
<body>
    ...
    <section>
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">Beliya Official Shop</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @else
                        <a class="btn btn-outline-primary ms-2" href="{{ url('user/process-logout') }}">Logout</a>
                    @endif
